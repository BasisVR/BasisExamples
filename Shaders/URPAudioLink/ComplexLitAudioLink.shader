...
Shader "Universal Render Pipeline/Complex Lit AudioLink"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment UniversalFragmentMetaLitGIBoosted
    ...
    FallBack "Universal Render Pipeline/Lit AudioLink"
